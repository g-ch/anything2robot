// Generated by SolidPython 1.1.3 on 2024-08-02 10:24:28


union() {
	difference() {
		import(file = "/home/clarence/ros_ws/metamaterial_ws/src/metamaterial_filling/script/../data/output/FR_UP_replaced.stl", origin = [0, 0]);
		import(file = "/home/clarence/ros_ws/metamaterial_ws/src/metamaterial_filling/script/../data/output/FR_UP_replaced_smaller.stl", origin = [0, 0]);
	}
	intersection() {
		union() {
			union() {
						...
						union() {
							union() {
								multmatrix(m = [[0.8660254038, 0, -0.5000000000, -145.2000000000], [0, 1, 0, 0], [0.5000000000, 0, 0.8660254038, 0], [0, 0, 0, 1]]) {
									cube(center = true, size = [0.2000000000, 315.8880000000, 206.2977000000]);
								}
