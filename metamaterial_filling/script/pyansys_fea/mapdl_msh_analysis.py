...
'''
def static_fea_analysis(msh_file, elastic=210e3, poisson_ratio=0.3, fixed_nodes=None, closest_node_num_per_fixed=1, forces_nodes=None, forces=None, closest_node_num_per_force=1, display=True):
    ...
    for i in range(len(fixed_nodes)):
        nearest_n_indices = find_nearest_n_nodes(nodes, fixed_nodes[i], closest_node_num_per_fixed)
...
if __name__ == "__main__":
    ...
    max_stress, max_displacement, von_mises, displacement_magnitude, nodes = static_fea_analysis(msh_file=msh_file, elastic=args.elastic, poisson_ratio=args.poisson_ratio, fixed_nodes=args.fixed_nodes, closest_node_num_per_fixed=args.closest_node_num_per_fixed, forces_nodes=args.forces_nodes, forces=args.forces, closest_node_num_per_force=args.closest_node_num_per_force, display=args.display)
