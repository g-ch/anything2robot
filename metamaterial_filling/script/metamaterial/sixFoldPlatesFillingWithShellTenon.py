...
class SixFoldPlatesFillingWithShellTenon:
    def __init__(self, height, width, thickness, interval, plates_num, tilt_angle, input_stl_path, input_smaller_model_stl_path, input_tenon_stl_path, output_stl_path):
        self.height = height
        self.width = width
        ...
        self.input_tenon_stl_path = input_tenon_stl_path
...
if __name__ == '__main__':
    ...
    input_tenon_stl_path = '/home/clarence/git/anything2robot/anything2robot/metamaterial_filling/tenon/connection_child.stl'

    # Create the SixFoldPlatesFilling object
    sixFoldPlatesFilling = SixFoldPlatesFillingWithShellTenon(height, width, thickness, interval, plates_num, tilt_angle, input_stl_path, input_smaller_model_stl_path, input_tenon_stl_path, output_stl_path)
