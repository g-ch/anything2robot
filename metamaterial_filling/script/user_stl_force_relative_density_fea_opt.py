...
def stl_force_relative_density_fea_opt(stl_path_input=None, robot_result_file=None, output_folder=None, check_only=False, max_iteration=None, max_allowed_stress_material=None, max_allowed_displacement=None, display_fea_result=None, display_force_result=None, mapdl_object=None):
    ...
    parser.add_argument("--max_iteration", type=int, default=3, help="Maximum number of iterations")
    parser.add_argument("--initial_relative_density", type=float, default=0.4, help="Initial relative density of the metamaterial structure")
    ...
    if max_allowed_stress_material is not None:
        args.max_allowed_stress_material = max_allowed_stress_material
