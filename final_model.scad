// Generated by SolidPython 1.1.3 on 2024-12-08 16:45:53
			...
			union() {
				union() {
					union() {
						...
						import(file = "/home/clarence/git/anything2robot/anything2robot/metamaterial_filling/script/../data/output/motor_1_father_0_transformed_second_transformed.stl", origin = [0, 0]);
					}
					import(file = "/home/clarence/git/anything2robot/anything2robot/metamaterial_filling/script/../data/output/motor_1_father_1_transformed_second_transformed.stl", origin = [0, 0]);
				}
				import(file = "/home/clarence/git/anything2robot/anything2robot/metamaterial_filling/script/../data/output/motor_1_father_2_transformed_second_transformed.stl", origin = [0, 0]);
			}
			import(file = "/home/clarence/git/anything2robot/anything2robot/metamaterial_filling/script/../data/output/motor_1_father_3_transformed_second_transformed.stl", origin = [0, 0]);
		}
		import(file = "/home/clarence/git/anything2robot/anything2robot/metamaterial_filling/script/../data/output/motor_0_father_4_transformed_second_transformed.stl", origin = [0, 0]);
	}
	import(file = "/home/clarence/git/anything2robot/anything2robot/metamaterial_filling/script/../data/output/motor_0_father_5_transformed_second_transformed.stl", origin = [0, 0]);
}
/***********************************************
*********      SolidPython code:      **********
************************************************
