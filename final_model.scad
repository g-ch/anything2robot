// Generated by SolidPython 1.1.3 on 2024-12-01 21:21:28


union() {
	union() {
		import(file = "/home/clarence/git/anything2robot/anything2robot/metamaterial_filling/script/../data/output/RL_UP_replaced.stl", origin = [0, 0]);
		import(file = "/home/clarence/git/anything2robot/anything2robot/metamaterial_filling/script/../data/output/motor_1_child_0_transformed_second_transformed.stl", origin = [0, 0]);
	}
