// Generated by SolidPython 1.1.3 on 2024-12-23 15:37:10


difference() {
	import(file = "/home/cc/git/anything2robot/metamaterial_filling/script/../data/output/RR_UP_replaced.stl", origin = [0, 0]);
	import(file = "/home/cc/git/anything2robot/metamaterial_filling/script/../data/output/motor_1_father_1_transformed_box_second_transformed.stl", origin = [0, 0]);
}
/***********************************************
*********      SolidPython code:      **********
************************************************
