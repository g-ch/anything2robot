...
class Quadruped_Mesh_Transformer():
    ...
    def load_joint_positions(self, joint_path : str):
        ...
        joint_dict["left_knee"] = joint_dict["left_knee"] + (center_knee - joint_dict["left_knee"]) * 0.12
        ...
        joint_dict["chest"][2] = joint_dict["left_shoulder"][2]
        joint_dict["chest"][1] = joint_dict["left_shoulder"][1]
    ...
    def set_links_and_nodes(self):
        ...
        link_config_dict = {
            "BODY": ["waist", "hip", "scapula", "head", "tail", "left_shoulder", "right_shoulder", "left_hip", "right_hip", "belly", "belly_front", "chest"],
