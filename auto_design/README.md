...
It will load the mesh from the file and provide the API to custumize the desired joints and links. After you have the desired configuration, you can save the configuration to a file and press "quit" to proceed to the next step.
